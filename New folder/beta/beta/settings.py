...
SECRET_KEY = 'django-insecure-((v7e)ar*x+0vpt$61((kfu@lot!b7pt#(x+#32gmx&@ajfn66'
...
OAUTH2_PROVIDER = {
    ...
    'ACCESS_TOKEN_EXPIRE_SECONDS': 600,  # Access token expiration time in seconds
    ...
    'ALLOWED_REDIRECT_URIS': [
        'https://jampass.onrender.com//apple/callback/',  
    ]
}
